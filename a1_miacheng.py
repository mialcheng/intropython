...
# A helper function to determine if a string can be converted to a floating point numbe
...
def find_students_south_of_wisconsin(data):
	...
	for student in data:
		...
		# print(student_lat)
		if student_lat != "" and is_float(student_lat): 
			student_lat = float(student_lat)
	...
	for student1 in data: 
		...
		#through the whole data set
			for student2 in data:
				if student2[INDEX_BIRTHDAY] != "":  #solves if birthday string of either student is empty (works!)
					birthday2 = student2[INDEX_BIRTHDAY]
					print([birthday1, birthday2])
					if student1[INDEX_BIRTHDAY] == student2[INDEX_BIRTHDAY] and student1 != student2: 
						if [student2, student1] not in buddies: 
						#if statment not working
							print([student1, student2])
							buddies.append([student1,student2])
